...
-- Create Rent Transactions Table
...
CREATE TABLE jobs(
    ...
    job_title VARCHAR2 (100) CONSTRAINT jobtitle_NN NOT NULL,
...
-- Create table detail rent transaction
...
-- Create table supertype without driver
...
-- Create table supertype with driver
